...
export const Estoque = () => {
  ...
  const opcoesCarrinhos = [
    { label: "Carrinho 1", value: "CARRINHO1" },
    { label: "Carrinho 1", value: "CARRINHO1" },
    { label: "Carrinho 1", value: "CARRINHO1" },
  ]
        ...
        <div className={estoque['carrinho']}>
          ...
          <div className={estoque["informacaoCarrinho"]}>
            <div className={estoque["eventoCarrinho"]}>
              <span>Evento:</span>
              <div className="w-1/2">
              <PickList  options={opcoesCarrinhos} /></div>
            </div>
            ...
            <div className={estoque["finalCarrinho"]}>
              <Button text={'Registrar Venda'} onClick={() => setOpenCarrinho(false)} secondary />
              <Button text={'Cancelar'} onClick={() => setOpenCarrinho(false)} />
            </div>
          </div>
