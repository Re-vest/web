...
export function Footer() {
  return (
    <footer
      id="contato"
      className="h-[464px] bg-blue-950 flex flex-col items-center justify-between py-24 px-48 text-white"
    >
      <div className="w-full flex justify-between">
        <div className="flex gap-8 items-center">
          <a
            href="https://www.google.com/maps/search/?api=1&query=Avenida+Souza+Ramos,+513,+08490490"
            target="_blank"
            rel="noopener noreferrer"
          >
            <img src={Email} alt="Localização" className="cursor-pointer" />
          </a>

          <div className="flex flex-col">
            <span className="font-bold text-2xl">Endereço</span>
            <p className="text-lg">Avenida Souza Ramos, 513 São Paulo - SP</p>
          </div>
        </div>
