...
export function Feedback({name, responsability, message}) {
  return (
    <div data-aos="fade-up" className="bg-white rounded-3xl flex flex-col lg:gap-15 gap-10 lg:py-16 py-10 lg:px-14 px-8 lg:w-[504px] w-4/5 h-[427px] h-[300px] drop-shadow-2xl">
